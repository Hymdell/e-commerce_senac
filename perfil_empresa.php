            ...
            <div class="col-lg-12">
              ...
              <div class="col-lg-6">
                <fieldset>
                  ...
                  <input type="text" maxlength="15" minlength="15" name="cpfcnpj" id="cpf" placeholder="CNPJ" autocomplete="on" <?php echo 'value ="' . $dados[1] . '"'; ?> required>
                </fieldset>
              </div>
              <div class="col-lg-6">
                <fieldset>
              ...
              <div class="col-lg-6">
                <fieldset>
                  ...
                  <input type="text" maxlength="2" minlength="2" pattern="[A-Za-z]{2}" name="estado" id="estado" placeholder="Estado da empresa" <?php echo 'value ="' . $dados[4] . '"'; ?> required>
                </fieldset>
              </div>
              <div class="col-lg-6">
                <fieldset>
                  <label for="cidade">Cidade: </label>
                  <input type="text" maxlength="2" minlength="2" name="cidade" id="cidade" placeholder="Cidade da empresa" <?php echo 'value ="' . $dados[5] . '"'; ?> required>
                </fieldset>
              </div>
              <div class="col-lg-6">
                <fieldset>
