      ...
      <form action="cad_verifica.php" method="POST">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" maxlength="14" minlength="14" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" name="cpfcnpj" placeholder="Seu CPF Ex: xxx.xxx.xxx-xx" required>
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="text" maxlength="2" minlength="2"  pattern="[A-Za-z]{2}" name="estado" placeholder="Seu Estado, Ex: SP" required>
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="number" maxlength="4" minlength="2" name="numero" placeholder="Número do local" required>
          </div>
          <div class="input-box">
