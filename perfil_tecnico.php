            ...
            <div class="col-lg-12">
              ...
              <div class="col-lg-6">
                <fieldset>
                  ...
                  <input type="number" name="rua" id="rua" placeholder="Sua Rua" required="">
                </fieldset>
              </div>
              <div class="col-lg-6">
                <fieldset>
              ...
              <div class="col-lg-12">
                <fieldset>
                  ...
                  <textarea name="resumo" type="text" class="form-control" id="resumo" placeholder="Um resumo sobre você e seus serviços" required=""></textarea>  
                </fieldset>
              </div>
              <div class="col-lg-12">
                <fieldset>
                  <label for="foto">Foto do seu local: </label>
